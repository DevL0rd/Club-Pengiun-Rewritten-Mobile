    ...
    r = {
        ...
        5: [function (t, i) {
            ...
            o.xhr = function (t, n, r) {
                if (n.binary) {
                    var t = '{"nested":{"cprewritten":{"nested":{"social":{"nested":{"Friend":{"fields":{"name":{"type":"string","id":1},"id":{"type":"int32","id":2},"swid":{"type":"string","id":3},"world":{"type":"int32","id":4}}},"FriendsList":{"fields":{"friend":{"rule":"repeated","type":"Friend","id":1}}},"IgnoreList":{"fields":{"penguin":{"rule":"repeated","type":"Friend","id":1}}},"FriendRequest":{"fields":{"id":{"type":"int32","id":1},"name":{"type":"string","id":2}}},"AddFriend":{"fields":{"friend":{"type":"Friend","id":1}}},"RemoveFriend":{"fields":{"friend":{"type":"Friend","id":1}}},"UpdateWorld":{"fields":{"friend":{"type":"int32","id":1},"world":{"type":"int32","id":2}}},"AddIgnore":{"fields":{"penguin":{"type":"Friend","id":1}}},"RemoveIgnore":{"fields":{"penguin":{"type":"Friend","id":1}}},"Authenticate":{"fields":{"id":{"type":"int32","id":1},"key":{"type":"string","id":2},"agent":{"type":"string","id":3},"protocol":{"type":"int32","id":4}}},"Error":{"fields":{"id":{"type":"int32","id":1},"message":{"type":"string","id":2}}},"PacketWrapper":{"oneofs":{"packet":{"oneof":["authenticate","updateWorld","friendsList","ignoreList","friendRequest","addFriend","removeFriend","addIgnore","removeIgnore","error"]}},"fields":{"id":{"type":"int32","id":1},"authenticate":{"type":"Authenticate","id":2},"updateWorld":{"type":"UpdateWorld","id":3},"friendsList":{"type":"FriendsList","id":4},"ignoreList":{"type":"IgnoreList","id":5},"friendRequest":{"type":"FriendRequest","id":6},"addFriend":{"type":"AddFriend","id":7},"removeFriend":{"type":"RemoveFriend","id":8},"addIgnore":{"type":"AddIgnore","id":9},"removeIgnore":{"type":"RemoveIgnore","id":10},"error":{"type":"Error","id":11}}}}}}}}}';
                    if (!t) {
                        t = [];
                        for (var i = 0; i < t.length; ++i) t.push(255 & t.charCodeAt(i))
                    }
        ...
        6: [function (t, i) {
            function n(o) {
                return "undefined" != typeof Float32Array ? function () {
                    ...
                    function s(t, i) {
                        return e[0] = t[i], e[1] = t[i + 1], e[2] = t[i + 2], e[3] = t[i + 3], e[4] = t[i + 4], e[5] = t[i + 5], e[6] = t[i + 6], e[7] = t[i + 7], r[0]
                    }

                    function u(t, i) {
                        return e[7] = t[i], e[6] = t[i + 1], e[5] = t[i + 2], e[4] = t[i + 3], e[3] = t[i + 4], e[2] = t[i + 5], e[1] = t[i + 6], e[0] = t[i + 7], r[0]
                    }
        ...
        13: [function (t, i) {
            i.exports = function (t) {
                ...
                for (var n = 0; n < t.fieldsArray.length; ++n) {
                    ...
                    i("case %i:", r.id), r.map ? (i("r.skip().pos++")("if(%s===util.emptyObject)", s)("%s={}", s)("k=r.%s()", r.keyType)("r.pos++"), f.long[r.keyType] !== tt ? f.basic[e] === tt ? i('%s[typeof k==="object"?util.longToHash(k):k]=types[%i].decode(r,r.uint32())', s, n) : i('%s[typeof k==="object"?util.longToHash(k):k]=r.%s()', s, e) : f.basic[e] === tt ? i("%s[k]=types[%i].decode(r,r.uint32())", s, n) : i("%s[k]=r.%s()", s, e)) : r.repeated ? (i("if(!(%s&&%s.length))", s, s)("%s=[]", s), f.packed[e] !== tt && i("if((t&7)===2){")("var c2=r.uint32()+r.pos")("while(r.pos<c2)")("%s.push(r.%s())", s, e)("}else"), f.basic[e] === tt ? i(r.resolvedType.group ? "%s.push(types[%i].decode(r))" : "%s.push(types[%i].decode(r,r.uint32()))", s, n) : i("%s.push(r.%s())", s, e)) : f.basic[e] === tt ? i(r.resolvedType.group ? "%s=types[%i].decode(r)" : "%s=types[%i].decode(r,r.uint32())", s, n) : i("%s=r.%s()", s, e), i("break")
                }
            ...
            i.exports = function (t) {
                for (var i, n = c.codegen(["m", "w"], t.name + "$encode")("if(!w)")("w=Writer.create()"), r = t.fieldsArray.slice().sort(c.compareFieldsById), e = 0; e < r.length; ++e) {
                    var s = r[e].resolve(),
                        ...
                        f = a.basic[o];
                    i = "m" + c.safeProp(s.name), s.map ? (n("if(%s!=null&&m.hasOwnProperty(%j)){", i, s.name)("for(var ks=Object.keys(%s),i=0;i<ks.length;++i){", i)("w.uint32(%i).fork().uint32(%i).%s(ks[i])", (s.id << 3 | 2) >>> 0, 8 | a.mapKey[s.keyType], s.keyType), f === tt ? n("types[%i].encode(%s[ks[i]],w.uint32(18).fork()).ldelim().ldelim()", u, i) : n(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | f, o, i), n("}")("}")) : s.repeated ? (n("if(%s!=null&&%s.length){", i, i), s.packed && a.packed[o] !== tt ? n("w.uint32(%i).fork()", (s.id << 3 | 2) >>> 0)("for(var i=0;i<%s.length;++i)", i)("w.%s(%s[i])", o, i)("w.ldelim()") : (n("for(var i=0;i<%s.length;++i)", i), f === tt ? l(n, s, u, i + "[i]") : n("w.uint32(%i).%s(%s[i])", (s.id << 3 | f) >>> 0, o, i)), n("}")) : (s.optional && n("if(%s!=null&&m.hasOwnProperty(%j))", i, s.name), f === tt ? l(n, s, u, i) : n("w.uint32(%i).%s(%s)", (s.id << 3 | f) >>> 0, o, i))
                }
                return n("return w")
            };
            var h = t(15),
        ...
        15: [function (t, i) {
            ...
            function e(t, i, n, r, e) {
                ...
                if (this.valuesById = {}, this.values = Object.create(this.valuesById), this.comment = r, this.comments = e || {}, this.reserved = tt, i)
            ...
            e.fromJSON = function (t, i) {
                ...
                return r.toObject(["options", this.options, "values", this.values, "reserved", this.reserved && this.reserved.length ? this.reserved : tt, "comment", i ? this.comment : tt, "comments", i ? this.comments : tt])
        ...
        16: [function (t, i) {
            ...
            function u(t, i, n, r, e, s, u) {
                if (h.isObject(r) ? (u = e, s = r, r = e = tt) : h.isObject(e) && (u = s, s = e, e = tt), o.call(this, t, s), !h.isInteger(i) || i < 0) throw TypeError("id must be a non-negative integer");
                ...
                this.rule = r && "optional" !== r ? r : tt, this.type = n, this.id = i, this.extend = e || tt, this.required = "required" === r, this.optional = !this.required, this.repeated = "repeated" === r, this.map = !1, this.message = null, this.partOf = null, this.typeDefault = null, this.defaultValue = null, this.long = !!h.Long && f.long[n] !== tt, this.bytes = "bytes" === n, this.resolvedType = null, this.extensionField = null, this.declaringField = null, this.u = null, this.comment = u
            }
        ...
        18: [function (t, i, n) {
            ...
            r.build = "minimal", r.Writer = t(42), r.BufferWriter = t(43), r.Reader = t(27), r.BufferReader = t(28), r.util = t(39), r.rpc = t(31), r.roots = t(30), r.configure = e, r.Writer.o(r.BufferWriter), e()
        }, {
            27: 27,
            28: 28,
            30: 30,
        ...
        20: [function (t, i) {
            ...
            function s(t, i, n, r, e, s) {
                if (u.call(this, t, i, r, tt, tt, e, s), !o.isString(n)) throw TypeError("keyType must be a string");
            ...
            s.fromJSON = function (t, i) {
                ...
                var i = !!t && !!t.keepComments;
                return o.toObject(["keyType", this.keyType, "type", this.type, "id", this.id, "extend", this.extend, "options", this.options, "comment", i ? this.comment : tt])
            }, s.prototype.resolve = function () {
                if (this.resolved) return this;
                if (n.mapKey[this.keyType] === tt) throw Error("invalid key type: " + this.keyType);
        ...
        22: [function (t, i) {
            ...
            function n(t, i, n, r, e, s, u, o) {
                if (h.isObject(e) ? (u = e, e = s = tt) : h.isObject(s) && (u = s, s = tt), i !== tt && !h.isString(i)) throw TypeError("type must be a string");
                ...
                f.call(this, t, u), this.type = i || "rpc", this.requestType = n, this.requestStream = !!e || tt, this.responseType = r, this.responseStream = !!s || tt, this.resolvedRequestType = null, this.resolvedResponseType = null, this.comment = o
            }
            n.fromJSON = function (t, i) {
                ...
                var i = !!t && !!t.keepComments;
                return h.toObject(["type", "rpc" !== this.type && this.type || tt, "requestType", this.requestType, "requestStream", this.requestStream, "responseType", this.responseType, "responseStream", this.responseStream, "options", this.options, "comment", i ? this.comment : tt])
        ...
        23: [function (t, i) {
            ...
            h.fromJSON = function (t, i) {
                ...
                if (t)
                    for (var i, n = Object.keys(t), r = 0; r < n.length; ++r) i = t[n[r]], this.add((i.fields !== tt ? e.fromJSON : i.values !== tt ? u.fromJSON : i.methods !== tt ? s.fromJSON : i.id !== tt ? o.fromJSON : h.fromJSON)(n[r], i));
                return this
                ...
                if (!(t instanceof o && t.extend !== tt || t instanceof e || t instanceof u || t instanceof s || t instanceof h)) throw TypeError("object must be a valid nested object");
                if (this.nested) {
                ...
                return delete this.nested[t.name], Object.keys(this.nested).length || (this.nested = tt), t.onRemove(this), a(this)
                ...
                if ("boolean" == typeof i ? (n = i, i = tt) : i && !Array.isArray(i) && (i = [i]), f.isString(t) && t.length) {
        ...
        24: [function (t, i) {
            ...
            function e(t, i) {
                ...
                this.options = i, this.name = t, this.parent = null, this.resolved = !1, this.comment = null, this.filename = null
            }
        ...
        25: [function (t, i) {
            ...
            s.fromJSON = function (t, i) {
                ...
                var i = !!t && !!t.keepComments;
                return r.toObject(["options", this.options, "oneof", this.oneof, "comment", i ? this.comment : tt])
        ...
        26: [function (t, i) {
            (i.exports = Y).filename = null, Y.defaults = {
                keepCase: !1
            };
            var M = t(34),
                I = t(29),
            ...
            function Y(t, i, n) {
                ...
                var r, e, s, u, o, f = M(t, n.alternateCommentMode || !1),
                    h = f.next,
                    a = f.push,
                    c = f.peek,
                    l = f.skip,
                ...
                function b(t, i, n) {
                    var r = Y.filename;
                    return n || (Y.filename = null), Error("illegal " + (i || "token") + " '" + t + "' (" + (r ? r + ", " : "") + "line " + f.line + ")")
                }
                ...
                function j(t, i) {
                    for (var n, r; !i || '"' !== (n = c()) && "'" !== n ? t.push([r = k(h()), l("to", !0) ? k(h()) : r]) : t.push(m()), l(",", !0););
                    l(";")
                }
                ...
                function A() {
                    if (l("="), u = m(), !(p = "proto3" === u) && "proto2" !== u) throw b(u, "syntax");
                    l(";")
                }
                                    ...
                                    if (!x(n, t)) switch (t) {
                                        ...
                                        case "oneof":
                                            ! function (t, i) {
                                                ...
                                                var n = new _(y(i));
                                                S(n, function (t) {
                                                    "option" === t ? (N(n, t), l(";")) : (a(t), T(n, "optional"))
                                                }), t.add(n)
                                            }(n, t);
                                            break;
                                        case "extensions":
                                ...
                                S(n, function (t) {
                                    if (!x(n, t)) {
                                        ...
                                        ! function (t, i) {
                                            ...
                                            r = i, l(")"), l("returns"), l("("), l("stream", !0) && (u = !0);
                                            if (!K.test(i = h())) throw b(i);
                                            s = i, l(")");
                ...
                function S(t, i, n) {
                    ...
                    if (t && (t.comment = v(), t.filename = Y.filename), l("{", !0)) {
                        for (var e;
                            "}" !== (e = h());) i(e);
                        l(";", !0)
                    } else n && n(), l(";"), t && "string" != typeof t.comment && (t.comment = v(r))
                }
                ...
                function T(t, i, n) {
                    ...
                    if ("group" !== r) {
                        ...
                        S(s, function (t) {
                            ...
                            $(s)
                        }), t.add(s), p || !s.repeated || Z.packed[r] === tt && Z.basic[r] !== tt || s.setOption("packed", !1, !0)
                    } else ! function (t, i) {
                        var n = h();
                        ...
                        s.group = !0;
                        var u = new L(r, e, n, i);
                        u.filename = Y.filename, S(s, function (t) {
                            switch (t) {
                                case "option":
                                    N(s, t), l(";");
                                    break;
                ...
                function N(t, i) {
                    ...
                    var r = i;
                    n && (l(")"), r = "(" + r + ")", i = c(), Q.test(i) && (r += i, h())), l("="),
                        function t(i, n) {
                            if (l("{", !0))
                                do {
                                    if (!G.test(o = h())) throw b(o, "name");
                                    "{" === c() ? t(i, n + "." + o) : (l(":"), "{" === c() ? t(i, n + "." + o) : V(i, n + "." + o, g(!0))), l(",", !0)
                                } while (!l("}", !0));
                            else V(i, n, g(!0))
                        }(t, r)
                }
        ...
        27: [function (t, i) {
            ...
            } : h, o.prototype.c = r.Array.prototype.subarray || r.Array.prototype.slice, o.prototype.uint32 = (f = 4294967295, function () {
        ...
        28: [function (t, i) {
            ...
            r.Buffer && (e.prototype.c = r.Buffer.prototype.slice), e.prototype.string = function () {
                var t = this.uint32();
        ...
        29: [function (t, i) {
            ...
            n.fromJSON = function (t, i) {
            ...
            }, n.prototype.resolvePath = p.path.resolve, n.prototype.load = function t(i, s, u) {
                    ...
                    try {
                        if (p.isString(i) && "{" === i.charAt(0) && (i = JSON.parse(i)), p.isString(i)) {
                            ...
                            var n, r = v(i, o, s),
                                e = 0;
                            if (r.imports)
                                for (; e < r.imports.length; ++e)(n = o.resolvePath(t, r.imports[e])) && c(n);
                            if (r.weakImports)
                                for (e = 0; e < r.weakImports.length; ++e)(n = o.resolvePath(t, r.weakImports[e])) && c(n, !0)
                ...
                function c(n, r) {
                    ...
                    if (!(-1 < o.files.indexOf(n)))
                        if (o.files.push(n), n in d) f ? a(n, d[n]) : (++l, setTimeout(function () {
                            --l, a(n, d[n])
                        }));
                        else if (f) {
                            var e;
                            ...
                            a(n, e)
                        } else ++l, p.fetch(n, function (t, i) {
                            --l, u && (t ? r ? l || h(null, o) : h(t) : a(n, i))
                        })
                }
                var l = 0;
                p.isString(i) && (i = [i]);
            ...
            n.prototype.h = function (t) {
                if (t instanceof s) t.extend === tt || t.extensionField || h(0, t) || this.deferred.push(t);
        ...
        33: [function (t, i) {
            ...
            u.fromJSON = function (t, i) {
                ...
                var i = r.prototype.toJSON.call(this, t),
                    n = !!t && !!t.keepComments;
                return o.toObject(["options", i && i.options || tt, "methods", r.arrayToJSON(this.methodsArray, t) || {}, "nested", i && i.nested || tt, "comment", n ? this.comment : tt])
        ...
        34: [function (t, i) {
            ...
            function e(o, f) {
                ...
                function m(t, i) {
                    ...
                    for (var e = o.substring(t, i).split(T), s = 0; s < e.length; ++s) e[s] = e[s].replace(f ? S : x, "").trim();
                    l = e.join("\n").trim()
                }
                ...
                return Object.defineProperty({
                    ...
                    cmnt: function (t) {
                        var i = null;
                        return t === tt ? v === c - 1 && (f || "*" === u || d) && (i = l) : (v < t && e(), v !== t || d || !f && "/" !== u || (i = l)), i
                    }
                }, "line", {
                    get: function () {
                        return c
        ...
        35: [function (t, i) {
            ...
            function m(t, i) {
                u.call(this, t, i), this.fields = {}, this.oneofs = tt, this.extensions = tt, this.reserved = tt, this.group = tt, this.v = null, this.e = null, this.p = null, this.w = null
            }
            ...
            Object.defineProperties(m.prototype, {
                ...
                if (i.nested)
                    for (r = Object.keys(i.nested), e = 0; e < r.length; ++e) {
                        var s = i.nested[r[e]];
                        n.add((s.id !== tt ? h.fromJSON : s.fields !== tt ? m.fromJSON : s.values !== tt ? o.fromJSON : s.methods !== tt ? c.fromJSON : u.fromJSON)(r[e], s))
                    }
                ...
                var i = u.prototype.toJSON.call(this, t),
                    n = !!t && !!t.keepComments;
                return v.toObject(["options", i && i.options || tt, "oneofs", u.arrayToJSON(this.oneofsArray, t), "fields", u.arrayToJSON(this.fieldsArray.filter(function (t) {
        ...
        39: [function (t, i, n) {
            ...
            r.asPromise = t(1), r.base64 = t(2), r.EventEmitter = t(4), r.float = t(6), r.inquire = t(7), r.utf8 = t(10), r.pool = t(9), r.LongBits = t(38), r.global = "undefined" != typeof window && window || "undefined" != typeof global && global || "undefined" != typeof self && self || this, r.emptyArray = Object.freeze ? Object.freeze([]) : [], r.emptyObject = Object.freeze ? Object.freeze({}) : {}, r.isNode = !!(r.global.process && r.global.process.versions && r.global.process.versions.node), r.isInteger = Number.isInteger || function (t) {
            ...
            }(), r.y = null, r.b = null, r.newBuffer = function (t) {
                return "number" == typeof t ? r.Buffer ? r.b(t) : new r.Array(t) : r.Buffer ? r.y(t) : "undefined" == typeof Uint8Array ? t : new Uint8Array(t)
                ...
                return function () {
                    for (var t = Object.keys(this), i = t.length - 1; - 1 < i; --i)
                        if (1 === n[t[i]] && this[t[i]] !== tt && null !== this[t[i]]) return t[i]
                }
        ...
        42: [function (t, i) {
            ...
            var p = r.Array.prototype.set ? function (t, i, n) {
                i.set(t, n)
            } : function (t, i, n) {
